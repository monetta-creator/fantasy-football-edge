...
| 5 | shipped 2026-09-05 (+ consistency check, correlated sim, props, Kalshi) | Vegas-implied DST streamer | Weekly DST ranking from opponent implied totals (points-allowed buckets dominate DST scoring) | ~15-30 pts vs. holding one DST | S | Stream the defense facing the lowest implied total. |
...
| 15 | proposed | Weekly props auto-pull (Sunday 9am) | Saves the manual press; ~90 credits/week fits the free tier | convenience | S | Scheduler job, off by default. |
| 16 | proposed | Line-move alerts | Compare consecutive pulls: pulled props = injury doubt; big line moves = news | injury edge | S | Needs two pulls per week (≈180 credits). |
