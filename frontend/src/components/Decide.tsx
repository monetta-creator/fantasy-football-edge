...
type Option = { id: string; name: string; pos: string; team: string | null; pts: number; ppg: number; vorp: number; adp: number; bye: number | null; roster_score: number; roster_score_se: number; delta_vs_best: number; p_gone_by_next: number | null; injury: Injury; reasons: Reason[]; history: { games: number; mean: number; sd: number } | null; wait_cost: number | null; wait_best: number | null };
